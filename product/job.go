...
type Job interface {
	DispatchWorkersCreateProductBulk_(jobs <-chan []interface{}, wg *sync.WaitGroup)
}
...
func (j *job) DispatchWorkersCreateProductBulk_(jobs <-chan []interface{}, wg *sync.WaitGroup) {
